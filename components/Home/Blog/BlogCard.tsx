        ...
        <div className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <BiCalendar className="text-rose-500 w-4 h-4" />
              <span className="text-sm text-gray-700">{blog.date}</span>
            </div>
            <div className="flex items-center space-x-2">
              <BiMessage className="text-rose-500 w-4 h-4" />
          ...
          <div className="flex items-center mt-4 cursor-pointer space-x-2 hover:text-red-500">
            <span className="font-bold text-base">Read More</span>
            <BsArrowRight className="text-rose-500 w-4 h-4" />
          </div>
        </div>
      </div>
    </div>
